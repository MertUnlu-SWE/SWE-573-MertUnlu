...
urlpatterns = [
    ...
    path('comment/<int:comment_id>/bookmark/', views.bookmark_comment, name='bookmark_comment'),
    path('comment/<int:comment_id>/unbookmark/', views.unbookmark_comment, name='unbookmark_comment'),
